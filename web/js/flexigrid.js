    ...
    $.addFlex = function (t, p) {
        ...
        var g = {
            ...
            changeSort: function (th) { //change sortorder
                ...
                $(th).addClass('sorted').siblings().addClass('sorted');
...
//                    }
        ...
        if (p.usepager) {
            ...
            if (p.searchitems) {
                ...
                $(g.sDiv).append("<div class='sDiv2'>快速搜索 <input type='text' size='30' name='q' class='qsbox' /> <select name='qtype'>" + sopt + "</select> <input type='button' value='Clear' /></div>");
